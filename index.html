...
const firebaseConfig = {  
  ...
  projectId: "honor-tv",  
  storageBucket: "honor-tv.firebasestorage.app",  
...
// --- Detect Adblock DNS ---
async function detectAdblockDNS() {
  try {
...
detectAdblockDNS().then(blocked => {
  if (blocked) {
    document.body.innerHTML = `
      <div style="color: red; font-size: 20px; text-align: center; padding: 50px;">
        🚫 Access Denied <br><br>
        Please disable your DNS ad-blocker to use this website.
      </div>`;
  }
});
